...
public class MyNLP {
    ...
    /**
     * Searches the text for a specific word or phrase
     * Keyword Spotting / Frequency Analysis
    ...
    public int countOccurrences(String target) {
        ...
        // Store data in our ArrayLists to track history
    ...
    //The Introduction of our scanner. 
    public void prompt() {
        Scanner input = new Scanner(System.in);

        System.out.println("|--- Welcome to the Essay Analyzer ---|");
        System.out.println("Enter a word or phrase to count (or type 'quit' to stop the program):");
